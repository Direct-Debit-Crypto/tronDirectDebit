...
export default function WhitelistedVendors() {
  ...
  const getContractData = async () => {
    ...
    if (tronWEB?.defaultAddress?.base58) {
      ...
      //Get contract
      const contractListDebit = await tronWEB.contract().at(ListViewAddress.TESTNET_SHASTA_LIST_VENDORS);
      ...
      //Get tags
      const allTags = await contractListDebit.getAllTags().call();
      console.log(allTags);
